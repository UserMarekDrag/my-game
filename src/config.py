...
class Config:
    ...
    def __new__(cls):
        ...
        if cls._instance is None:
            ...
            pygame.font.init()
            cls._instance.health_font = pygame.font.SysFont('comicsans', 20)
            cls._instance.winner_font = pygame.font.SysFont('comicsans', 100)
            cls._instance.stage_numb_font = pygame.font.SysFont('comicsans', 100)
